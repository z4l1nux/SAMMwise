 ...
 * Accepts computed scores and optional previous assessment data.
 */
...
/**
 * @param {object} params
 * @param {number}   params.overallScore        0–3 float
 * @param {string[]} params.bfNames             5 business function names
 * @param {number[]} params.bfScores            5 scores 0–3
 * @param {string[]} params.practiceNames       15 practice names
 * @param {number[]} params.practiceScores      15 scores 0–3
 * @param {object}   params.responseCount       {No, Yes for some, Yes for most, Yes for all}
 * @param {string}   params.company
 * @param {string}   params.project
 * @param {object|null} params.previous         same shape for previous assessment, or null
 * @param {string}   params.locale              'en' | 'pt'
 */
export function buildPrompt({ overallScore, bfNames, bfScores, practiceNames, practiceScores, responseCount, company, project, previous, locale }) {
